<ul class="quicklinks ul-none no-padding mb-3">
    ...
    <li @if(Route::current()->getName() == 'profile.wishlist') class="active" @endif><a href="{{ route('profile.wishlist') }}">My Wishlist <span style="background-color: white; height: 23px; width: 20px;" class="badge">{{ \App\Models\CustomerWishlist::wishlist_available() }}</span></a></li>
