            ...
            <div id="header-wrap">
                <div class="container">
                    <div class="header-row">
                        ...
                        ============================================= -->
                        <div id="logo">
                            <a href="demo-freelancer.html" class="standard-logo"><img src="{{ asset('theme/'.env('THEME_FOLDER').'/images/logo.png') }}" alt="Canvas Logo"></a>
                            <a href="demo-freelancer.html" class="retina-logo"><img src="{{ asset('theme/'.env('THEME_FOLDER').'/images/logo@2x.png') }}" alt="Canvas Logo"></a>
                        </div><!-- #logo end -->
            ...
            <div class="content-wrap p-0">
                ...
                <div class="section mb-0 pt-3 pb-0" style="background-color: #F4F4F4; margin-top: 150px; overflow: visible;">
                    ...
                    <div class="d-flex justify-content-center position-relative">
                        <div class="parallax min-vh-75" style="background-image: url({{URL::asset("theme/".env('THEME_FOLDER')."/images/me.jpg")}}); background-size: cover; background-position: center center;" data-bottom-top="width: 40vw" data-center-top="width: 100vw;">
                ...
                <div class="section bg-transparent py-5">
                    <div class="container">
                        <div class="row align-items-center justify-content-around">
                                        ...
                                        <div class="testimonial border-0 shadow-none bg-transparent">
                                            <div class="testi-content">
                                                ...
                                                <div class="testi-meta d-flex align-items-center">
                                                    <img src="{{ asset('theme/'.env('THEME_FOLDER').'/images/testi/face.jpg') }}" alt="Face" width="30">
                                                    <div>
                                                        John Doe
                                    ...
                                    <div class="oc-item">
                                        <div class="testimonial border-0 shadow-none bg-transparent">
                                            <div class="testi-content">
                                                ...
                                                <div class="testi-meta d-flex align-items-center">
                                                    <img src="{{ asset('theme/'.env('THEME_FOLDER').'/images/testi/face2.jpg') }}" alt="Face" width="30">
                                                    <div>
                                                        John Doe
                                                        <span class="ps-0">XYZ Inc.</span>
                                                    </div>
                                    ...
                                    <div class="oc-item">
                                        <div class="testimonial border-0 shadow-none bg-transparent">
                                            <div class="testi-content">
                                                ...
                                                <div class="testi-meta d-flex align-items-center">
                                                    <img src="{{ asset('theme/'.env('THEME_FOLDER').'/images/testi/face3.jpg') }}" alt="Face" width="30">
                                                    <div>
                                                        John Doe
                                                        <span class="ps-0">XYZ Inc.</span>
                                                    </div>
                            ...
                            <div class="col-lg-6">
                                <img src="{{ asset('theme/'.env('THEME_FOLDER').'/images/testi/bg.svg') }}" alt="">
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row justify-content-center col-mb-50">
                            <div class="col-lg-6 h-translatey-3 tf-ts">
                                <a href="demo-store.html" class="portfolio-item" target="_blank">
                                    <div class="portfolio-image">
                                        <img src="{{ asset('theme/'.env('THEME_FOLDER').'/images/works/1.jpg') }}" alt="Portfoio Item">
                            ...
                            <div class="col-lg-6 h-translatey-3 tf-ts">
                                <a href="demo-yoga.html" class="portfolio-item" target="_blank">
                                    <div class="portfolio-image">
                                        <img src="{{ asset('theme/'.env('THEME_FOLDER').'/images/works/2.jpg') }}" alt="Portfoio Item">
                                        <div class="bg-overlay">
                                            <div class="bg-overlay-content align-items-start justify-content-start flex-column px-5 py-4">
                            ...
                            <div class="col-lg-6 h-translatey-3 tf-ts">
                                <a href="demo-hostel.html" class="portfolio-item" target="_blank">
                                    <div class="portfolio-image">
                                        <img src="{{ asset('theme/'.env('THEME_FOLDER').'/images/works/3.jpg') }}" alt="Portfoio Item">
                                        <div class="bg-overlay">
                                            <div class="bg-overlay-content align-items-start justify-content-start flex-column px-5 py-4">
                            ...
                            <div class="col-lg-6 h-translatey-3 tf-ts">
                                <a href="demo-conference.html" class="portfolio-item" target="_blank">
                                    <div class="portfolio-image">
                                        <img src="{{ asset('theme/'.env('THEME_FOLDER').'/images/works/4.jpg') }}" alt="Portfoio Item">
                                        <div class="bg-overlay">
                                            <div class="bg-overlay-content align-items-start justify-content-start flex-column px-5 py-4">
                        ...
                        <div  class="row gutter-50 mb-5 align-items-stretch">
                                    ...
                                    <div class="mt-auto">
                                        <div class="card-body">
                                            <div class="d-flex align-items-center mb-4">
                                                <img src="{{ asset('theme/'.env('THEME_FOLDER').'/images/icons/sketch.svg') }}" height="50" alt="Image">
                                                <img src="{{ asset('theme/'.env('THEME_FOLDER').'/images/icons/xd.png') }}" height="50" alt="Image" class="ms-3">
                                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="card d-flex align-items-end flex-column p-4 border-0" style="background-color: #C2DFEC;">
                                    ...
                                    <div class="mt-auto">
                                        <div class="card-body">
                                            <img src="{{ asset('theme/'.env('THEME_FOLDER').'/images/icons/social.svg') }}" alt="Image" class="mb-4" height="50">
                            ...
                            <div class="col-md-4">
                                <div class="card d-flex align-items-end flex-column p-4 border-0" style="background-color: #FADCE4">
                                    ...
                                    <div class="mt-auto">
                                        <div class="card-body">
                                            <img src="{{ asset('theme/'.env('THEME_FOLDER').'/images/icons/wp.png') }}" height="50" alt="Image" class="mb-4">
                            ...
                            <div class="col-md-4">
                                <div class="card d-flex align-items-end flex-column p-4 border-0" style="background-color: #E4E4E4">
                                    ...
                                    <div class="mt-auto">
                                        <div class="card-body">
                                            <img src="{{ asset('theme/'.env('THEME_FOLDER').'/images/icons/seo.svg') }}" height="50" alt="Image" class="mb-4">
                            ...
                            <div class="col-md-4">
                                <div class="card d-flex align-items-end flex-column p-4 border-0" style="background-color: #E5E3CE;">
                                    ...
                                    <div class="mt-auto">
                                        <div class="card-body">
                                            <img src="{{ asset('theme/'.env('THEME_FOLDER').'/images/icons/hosting.svg') }}" height="50" alt="Image" class="mb-4">
                            ...
                            <div class="col-md-4">
                                <div class="card d-flex align-items-end flex-column p-4 border-0" style="background-color: #C9D6CF">
                                    ...
                                    <div class="mt-auto">
                                        <div class="card-body">
                                            <img src="{{ asset('theme/'.env('THEME_FOLDER').'/images/icons/plugins.png') }}" height="50" alt="Image" class="mb-4">
                    ...
                    <div class="container mt-6">
                        ...
                        <div class="section rounded-10 p-6 my-4" style="background-color: #F1F1F1;">
                            <div class="row justify-content-between align-items-center col-mb-50">
                                <div class="col-md-3 col-6 center"><img src="{{ asset('theme/'.env('THEME_FOLDER').'/images/clients/amazon.svg') }}" alt="Clients"></div>
                                <div class="col-md-3 col-6 center"><img src="{{ asset('theme/'.env('THEME_FOLDER').'/images/clients/netflix.svg') }}" alt="Clients"></div>
                                <div class="col-md-3 col-6 center"><img src="{{ asset('theme/'.env('THEME_FOLDER').'/images/clients/google.svg') }}" alt="Clients"></div>
                                <div class="col-md-3 col-6 center"><img src="{{ asset('theme/'.env('THEME_FOLDER').'/images/clients/paypal.svg') }}" alt="Clients"></div>
                                <div class="col-md-3 col-6 center"><img src="{{ asset('theme/'.env('THEME_FOLDER').'/images/clients/skype.svg') }}" alt="Clients"></div>
                                <div class="col-md-3 col-6 center"><img src="{{ asset('theme/'.env('THEME_FOLDER').'/images/clients/ps.svg') }}" alt="Clients"></div>
                                <div class="col-md-3 col-6 center"><img src="{{ asset('theme/'.env('THEME_FOLDER').'/images/clients/slack.svg') }}" alt="Clients"></div>
                                <div class="col-md-3 col-6 center"><img src="{{ asset('theme/'.env('THEME_FOLDER').'/images/clients/applemusic.svg') }}" alt="Clients"></div>
                            </div>
                        </div>
                    </div>
                </div>

                <div class="section m-0" style="background: #f1efe5 url({{URL::asset("theme/'.env('THEME_FOLDER').'/images/bg.svg")}}) no-repeat right center; padding-top: 240px">
                    ...
                    <div class="container">
                        <div class="row align-items-center">
                            ...
                            <div class="col-lg-7">
                                <img src="{{ asset('theme/'.env('THEME_FOLDER').'/images/ask.svg') }}" alt="FAQs" class="px-5">
                            </div>
                        </div>
                    </div>
                </div>
