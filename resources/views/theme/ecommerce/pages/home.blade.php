		...
		<div class="modal1 mfp-hide subscribe-widget mx-auto" id="myModal1" style="max-width: 750px;">
			<div class="row justify-content-center bg-white align-items-center" style="min-height: 380px;">
				<div class="col-md-5 p-0">
					<div style="background: url('{{URL::asset('theme/ecommerce/images/modals/modal1.jpg')}}') no-repeat center right; background-size: cover;  min-height: 380px;"></div>
				</div>
							...
							<ul class="top-links-container">
								...
								<li class="top-links-item"><a href="#">EN</a>
									<ul class="top-links-sub-menu">
										<li class="top-links-item"><a href="#"><img src="{{ asset('theme/ecommerce/images/icons/flags/french.png') }}" alt="French"> FR</a></li>
										<li class="top-links-item"><a href="#"><img src="{{ asset('theme/ecommerce/images/icons/flags/italian.png') }}" alt="Italian"> IT</a></li>
										<li class="top-links-item"><a href="#"><img src="{{ asset('theme/ecommerce/images/icons/flags/german.png') }}" alt="German"> DE</a></li>
									</ul>
								</li>
							</ul>
						</div><!-- .top-links end -->
					...
					<div class="header-row justify-content-lg-between">
						...
						<div class="header-misc">
							...
							<div id="top-cart" class="header-misc-icon d-none d-sm-block">
								<a href="#" id="top-cart-trigger"><i class="icon-line-bag"></i><span class="top-cart-number">{!! Setting::EcommerceCartTotalItems() !!}</span></a>
									...
									<div class="top-cart-items">
										<div class="top-cart-item">
											<div class="top-cart-item-image">
												<a href="#"><img src="{{ asset('theme/ecommerce/images/small/1.jpg') }}" alt="Blue Round-Neck Tshirt" /></a>
											</div>
										...
										<div class="top-cart-item">
											<div class="top-cart-item-image">
												<a href="#"><img src="{{ asset('theme/ecommerce/images/small/6.jpg') }}" alt="Light Blue Denim Dress" /></a>
											</div>
											<div class="top-cart-item-desc">
												<div class="top-cart-item-desc-title">
			...
			<div class="swiper-container swiper-parent">
				<div class="swiper-wrapper">
					<div class="swiper-slide dark">
						...
						<div class="swiper-slide-bg" style="background-image: url('{{URL::asset('theme/ecommerce/images/slider/1.jpg')}}');"></div>
					</div>
					<div class="swiper-slide dark">
						<div class="container">
							<div class="slider-caption slider-caption-center">
						...
						<div class="swiper-slide-bg" style="background-image: url('{{URL::asset('theme/ecommerce/images/slider/3.jpg')}}'); background-position: center 20%;"></div>
					</div>
					<div class="swiper-slide dark">
						<div class="container">
							<div class="slider-caption slider-caption-center">
						...
						<div class="swiper-slide-bg" style="background-image: url('{{URL::asset('theme/ecommerce/images/slider/2.jpg')}}'); background-position: center 40%;"></div>
					</div>
				</div>
				...
				<div class="container clearfix">
					...
					<div id="oc-products" class="owl-carousel products-carousel carousel-widget" data-margin="20" data-loop="true" data-autoplay="5000" data-nav="true" data-pagi="false" data-items-xs="1" data-items-sm="2" data-items-md="3" data-items-lg="4" data-items-xl="5">
								...
								<div class="product-image">
									...
									<div class="bg-overlay">
										<div class="bg-overlay-content align-items-end justify-content-between" data-hover-animate="fadeIn" data-hover-speed="400">
											<a href="javascript:void(0)" onclick="add_to_cart('1','1');" class="btn btn-dark me-2"><i class="icon-shopping-basket"></i></a>
										</div>
						...
						<div class="oc-item">
							<div class="product">
								<div class="product-image">
									<a href="#"><img src="{{ asset('theme/ecommerce/images/items/featured/2.jpg') }}" alt="Navy Blue Dress"></a>
									<a href="#"><img src="{{ asset('theme/ecommerce/images/items/featured/2-1.jpg') }}" alt="Navy Blue Dress"></a>
									<div class="bg-overlay">
										<div class="bg-overlay-content align-items-end justify-content-between" data-hover-animate="fadeIn" data-hover-speed="400">
											<a href="javascript:void(0)" onclick="add_to_cart('2','1');" class="btn btn-dark me-2"><i class="icon-shopping-basket"></i></a>
										</div>
										<div class="bg-overlay-bg bg-transparent"></div>
									</div>
								</div>
						...
						<div class="oc-item">
							<div class="product">
								<div class="product-image">
									<a href="#"><img src="{{ asset('theme/ecommerce/images/items/featured/5.jpg') }}" alt="Shoes"></a>
									<a href="#"><img src="{{ asset('theme/ecommerce/images/items/featured/5-1.jpg') }}" alt="Shoes"></a>
									<div class="bg-overlay">
									...
									<div class="fslider" data-arrows="false" data-autoplay="4500">
										<div class="flexslider">
											<div class="slider-wrap">
												<div class="slide"><a href="#"><img src="{{ asset('theme/ecommerce/images/items/featured/4.jpg') }}" alt="T-shirts"></a></div>
												<div class="slide"><a href="#"><img src="{{ asset('theme/ecommerce/images/items/featured/4-1.jpg') }}" alt="T-shirts"></a></div>
												<div class="slide"><a href="#"><img src="{{ asset('theme/ecommerce/images/items/featured/4-2.jpg') }}" alt="T-shirts"></a></div>
												<div class="slide"><a href="#"><img src="{{ asset('theme/ecommerce/images/items/featured/4-3.jpg') }}" alt="T-shirts"></a></div>
											</div>
										</div>
									</div>
									<div class="bg-overlay">
										<div class="bg-overlay-content align-items-end justify-content-between" data-hover-animate="fadeIn" data-hover-speed="400">
											<a href="javascript:void(0)" onclick="add_to_cart('3','1');" class="btn btn-dark me-2"><i class="icon-shopping-basket"></i></a>
										</div>
										<div class="bg-overlay-bg bg-transparent"></div>
									</div>
								</div>
						...
						<div class="oc-item">
							<div class="product">
								<div class="product-image">
									<a href="#"><img src="{{ asset('theme/ecommerce/images/items/featured/3.jpg') }}" alt="T-shirts"></a>
									<div class="bg-overlay">
										<div class="bg-overlay-content align-items-end justify-content-between" data-hover-animate="fadeIn" data-hover-speed="400">
											<a href="javascript:void(0)" onclick="add_to_cart('4','1');" class="btn btn-dark me-2"><i class="icon-shopping-basket"></i></a>
										</div>
										<div class="bg-overlay-bg bg-transparent"></div>
									</div>
								</div>
						...
						<div class="row align-items-stretch">
							<div class="col-md-5">
								<div class="row">
									...
									<div class="col-6">
										<a href="demos/shop/images/sections/1-2.jpg" data-lightbox="image"><img src="{{ asset('theme/ecommerce/images/sections/1-2.jpg') }}" alt="Image"></a>
									</div>
									<div class="col-6">
										<a href="demos/shop/images/sections/1-3.jpg" data-lightbox="image"><img src="{{ asset('theme/ecommerce/images/sections/1-3.jpg') }}" alt="Image"></a>
									</div>
								</div>
							</div>
							<div class="col-md-7 min-vh-50">
								<a href="https://www.youtube.com/watch?v=bpNcuh_BnsA" target="_blank" data-lightbox="iframe" class="d-block position-relative h-100" style="background: url('{{URL::asset('theme/ecommerce/images/sections/1.jpg')}}') center center no-repeat; background-size: cover;">
