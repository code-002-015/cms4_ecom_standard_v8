            ...
            <div>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb breadcrumb-style1 mg-b-5">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Template Categories</li>
                    </ol>
                </nav>
                <h4 class="mg-b-0 tx-spacing--1">Manage Template Categories</h4>
            </div>
        </div>
                    ...
                    <div class="d-md-flex bd-highlight">
                        ...
                        <div class="ml-auto bd-highlight mg-t-10">
                            <form class="form-inline" id="searchForm">
                                ...
                                <a class="btn btn-primary btn-sm mg-b-5 mt-lg-0 mt-md-0 mt-sm-0 mt-1" href="{{ route('template-categories.create') }}">Create a Category</a>
                            </form>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="table-responsive-lg">
                        <table class="table mg-b-0 table-light table-hover">
                            ...
                            <tr>
                                ...
                                <th scope="col" width="35%">Last Date Modified</th>
